...
const TEXT = {
  ...
  tr: {
    ...
    intro: "Gerekli performansı karşılayan vinçleri bulmak için tüm kaldırma noktası gereksinimlerini girin.",
    flat: "Yatay Bomlu Vinç",
    luffing: "Kalkar Bomlu Vinç",
    requirements: "Yarıçap Performans Gereksinimleri",
    point: "Nokta",
    radius: "Yarıçap",
    load: "Yük",
    ...
    prompt: "Önerileri görmek için her kaldırma noktasının yarıçapını ve yükünü girin.",
    noMatch: "Kayıtlı modeller arasında tüm kaldırma noktalarını karşıladığı doğrulanabilen bir model yoktur.",
