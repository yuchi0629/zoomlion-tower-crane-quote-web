...
const UI = {
  ...
  en: {
    ...
    machinePrice: "Main Unit Price",
    optionPrice: "Optional Parts Price",
    ...
    published: "Configuration Loaded",
    notPublished: "Configuration Not Loaded",
  ...
  fr: {
    ...
    machinePrice: "Prix de l'unite principale",
    optionPrice: "Prix des pieces en option",
    ...
    published: "Configuration enregistree",
    notPublished: "Configuration non enregistree",
  ...
  de: {
    ...
    machinePrice: "Preis der Haupteinheit",
    optionPrice: "Preis der Sonderausstattung",
    ...
    published: "Konfiguration geladen",
    notPublished: "Konfiguration nicht geladen",
  ...
  tr: {
    ...
    machinePrice: "Ana Ünite Fiyatı",
    optionPrice: "Opsiyonel Parça Fiyatı",
    ...
    published: "Konfigürasyon Yüklendi",
    notPublished: "Konfigürasyon Yüklenmedi",
